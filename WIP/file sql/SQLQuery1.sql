CREATE DATABASE Quanlikhambenh
use Quanlikhambenh
...
VALUES('PK001',	'BS001',	'BN001',	'01/01/2018',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt',	N'Viêm Xoan.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
...
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK003',	'BS002',	'BN007',	'03/02/2018',	N'Ho, hắt hơi thường xuyên',	N'Viêm phế quản.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK004',	'BS005',	'BN002',	'03/03/2018',	N'Chống mặt, nhức đầu thường xuyên.',	N'Huyết áp cao.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK005',	'BS001',	'BN001',	'07/03/2018',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt',	N'Viêm Xoan.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK006',	'BS002',	'BN003',	'15/3/2018',	N'Bỏng da', 	N'Viêm da.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK007',	'BS004',	'BN004',	'22/3/2018',	N'Đau khớp, sưng và cứng khớp,  viêm khớp',	 N'Thiếu canxi.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK008',	'BS005',	'BN006',	'24/3/2018',	N'Nhói tim.',	N'Cholesterol trong máu cao vì ăn quá nhiều đồ ăn dầu mỡ.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK009',	'BS001',	'BN008',	'25/3/2018',	N'Đau khớp',	N'Sụn khớp và thiếu canxi trầm trọng.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK010',	'BS003',	'BN009',	'04/01/2018',	N'Da nổi mẩn đỏ.',	N'Thủy đậu.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK011',	'BS004',	'BN010',	'04/03/2018',	N'Đau vùng gối thường xuyên',	N'Tổn thương tủy sống.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK012',	'BS001',	'BN011',	'04/04/2018',	N'Sưng và đau nhức ở cánh tay.', N'Vết thương bị nhiềm trùng.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK013',	'BS003',	'BN012',	'04/05/2018',	N'Vết thương không ngừng chảy máu',	N'Máu khó đông.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK014',	'BS002',	'BN013',	'08/05/2018',	N'Không thụ thai trong 4 năm',	N'Viêm nang buồng trứng.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK015',	'BS005',	'BN014',	'09/05/2018',	N'Đau nhói vùng sau gáy',	 N'Co thắt cơ.')
INSERT INTO PHIEUKHAM (MaPK, MaBS, MaBN, NgayKham, TrieuChung, KetQua)
VALUES('PK016',	'BS005',	'BN001',	'09/05/2018',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt.',	 N'Viêm Xoan.')
...
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD005',	'PK005',	100000,	150000,	250000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD006',	'PK006',	100000,	300000,	400000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD007',	'PK007',	100000,	300000,	400000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD008',	'PK008',	100000,	1000000,	1100000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD009',	'PK009',	100000,	300000,	400000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD010',	'PK010',	100000,	1000000,	1100000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD011',	'PK011',	100000,	300000,	400000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD012',	'PK012',	100000,	500000,	600000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD013',	'PK013',	100000,	2000000,	2100000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD014',	'PK014',	100000,	1000000,	1100000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD015',	'PK015',	100000,	500000,	600000)
INSERT INTO HOADON (MaHD, MaPK, TienKham, TienThuoc, TongTien)
VALUES('HD016',	'PK016',	100000,	500000,	600000)
...
INSERT INTO THUOC (TenThuoc, DonViTinh, Gia)
VALUES('Panadol',	N'Hộp',	500000)
INSERT INTO THUOC (TenThuoc, DonViTinh, Gia)
VALUES('Migrin',	N'Hộp',	150000)
INSERT INTO THUOC (TenThuoc, DonViTinh, Gia)
VALUES('Methylen',	N'Chai',150000)
...
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK005',	N'Migrin',	'1',	150000,	N'Uống 2-3 lần một ngày sau bữa ăn.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK006',	N'Bạc nitrat',	'1',	300000,	N'Thoa lên các vết bỏng  2-3 lần một tuần.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK007',	'Feldene',	'1',	300000,	N'Dùng 20 mg, uống một lần mỗi ngày hoặc 10 mg, uống hai lần mỗi ngày. Liều tối đa hàng ngày là 20 mg.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK008',	'Fenofibrat',	'2',	1000000,	N'Bạn uống 1 viên nén 145 mg 1 lần mỗi ngày. Những người đã sử dụng viên nang fenofibrat 200 mg hoặc viên nén 160 mg thời gian gần đây có thể chuyển sang uống viên nén 145 mg mà không cần hiệu chỉnh liều.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK09',	'Fenoprofen',	'1',	300000,	N'Dùng thuốc này bằng đường uống với một ly nước đầy (240 ml), trừ khi bác sĩ của bạn có chỉ dẫn khác. Đừng nằm xuống trong ít nhất 10 phút sau khi uống thuốc này. Nếu bạn bị khó chịu ở dạ dày trong khi dùng thuốc này, hãy uống thuốc với thực phẩm, sữa, hoặc thuốc kháng axit')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK010',	'Dacarbazine',	'1',	1000000,	N'Tiêm tĩnh mạch 2-4,5 mg/kg mỗi ngày một lần trong 10 ngày, lặp lại mỗi 4 tuần hoặc tiêm tĩnh mạch 250 mg/mÂ²  một lần mỗi ngày trong 5 ngày, lặp lại mỗi 3 tuần.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK011', 'Dantrolene',	'1',	300000,	N'Tiêm truyền tĩnh mạch: 2,5 mg/kg, bắt đầu khoảng 75 phút trước khi gây mê và truyền tĩnh mạch trong khoảng 1 giờ. Uống: 4-8 mg/kg/ngày uống chia thành ba hoặc bốn liều trong 1 hoặc 2 ngày trước khi phẫu thuật, liều cuối cùng uống với lượng nước tối thiểu khoảng 3-4 giờ trước khi phẫu thuật.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK012',	'Daptomycin',	'1',	500000,	N'Tiêm tĩnh mạch 6 mg/kg mỗi 24 tiếng trong 2 đến 6 tuần.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK013',	'Heparin',	'1',	2000000,	N'Đối với dạng thuốc truyền tĩnh mạch, bạn dùng khoảng 5000 đơn vị một lần, tiếp theo truyền tĩnh mạch liên tục 1300 đơn vị/giờ. Ngoài ra, bạn có thể tiêm tĩnh mạch một liều 80 đơn vị một lần. Sau đó, bạn có thể cần tiêm truyền tĩnh mạch liên tục 18 đơn vị/kg/giờ')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK014',	'Ganirelix',	'1',	1000000,	N'25 mg tiêm dưới da 1 lần/ngày. Ganirelix được dùng thuận tiện nhất ở vùng bụng quanh rốn hoặc đùi trên. Thông thường, nang hormone kích thích (FSH) ngoại sinh được tiêm trong ngày kinh thứ 2 hoặc 3. Ganirelix được bắt đầu tiêm vào ngày 7 hoặc 8 (ngày thứ 6 trong điều trị FSH). Trị liệu Ganirelix được tiếp tục cho đến khi nang trưởng thành đầy đủ, thời điểm đó sẽ bắt đầu tiêm hCG')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)
VALUES('PK015',	'Kaleorid',	'1',	500000,	N'Uống cả viên thuốc với 1 ly nước đầy.')
INSERT INTO CTTT (MaPK, TenThuoc, SoLuong, DonGia, CachDung)	
VALUES('PK016',	'Panadol',	'1',	500000,	N'Uống ba bữa trong ngày và sau khi ăn.')
...
select MaPK as[Mã PK], NgayKham as [Ngày Khám] 
from PHIEUKHAM 
where MaBN='BN001' 
order by NgayKham desc


select TenThuoc from CTTT ct, PHIEUKHAM pk where ct.MaPK = pk.MaPK and pk.MaPK = 'PK001'