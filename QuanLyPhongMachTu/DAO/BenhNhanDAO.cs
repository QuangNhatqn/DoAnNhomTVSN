...
namespace DAO
{
    public  class BenhNhanDAO
    {
        ...
        public static bool ThemBenhNhan(BENHNHAN bnDTO)
        {
            ...
            string sTruyVan = string.Format("insert into BENHNHAN values (N'{0}',N'{1}',N'{2}','{3}',N'{4}')", bnDTO.TenBN1, bnDTO.NgaySinh1, bnDTO.DiaChi1, bnDTO.DienThoai1, bnDTO.GioiTinh1); // MaBN tu dong tang
            Con = DataProvider_1.KetNoi();
            try
            {
                // thuc thi truy van
